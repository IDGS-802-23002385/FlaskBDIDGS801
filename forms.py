...
class cursoForm(Form):
    ...
    nombre=StringField('nombre',[validators.data_required(message="el campo es requerido"), 
                                 validators.length(min=3,max=10,message="el campo es requerido")])
    descripcion=StringField('descripcion',[validators.data_required(message="el campo es requerido"),validators.length(min=3,max=50,message="el campo es requerido")])
    id_maestro=IntegerField('id_maestro',[validators.data_required(message="el campo es requerido"),
                                        validators.number_range(min=1,max=1000,message="el campo es requerido")])
